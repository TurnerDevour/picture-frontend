    ...
    <a-card title="空间级别介绍">
      <a-typography-paragraph>
        * 目前仅支持开通普通版，如需升级空间，请联系
        <a href="https://codefather.cn" target="_blank">Turner</a>。
      </a-typography-paragraph>
      <a-typography-paragraph>
        <template v-for="spaceLevel in spaceLevelList">
...
const formData = reactive<API.SpaceAddDTO | API.SpaceUpdateDTO>({
  spaceName: '',
